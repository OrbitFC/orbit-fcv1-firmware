...
HAL_StatusTypeDef __lsm303_axread_single(uint8_t reg, uint8_t *pdata);
HAL_StatusTypeDef __lsm303_axwrite( uint8_t reg, size_t len, uint8_t *pdata);
HAL_StatusTypeDef __lsm303_axread(uint8_t reg, size_t len, uint8_t *pdata);

HAL_StatusTypeDef __lsm303_mwrite_single(uint8_t reg, uint8_t data);
HAL_StatusTypeDef __lsm303_mread_single(uint8_t reg, uint8_t *pdata);
HAL_StatusTypeDef __lsm303_mwrite( uint8_t reg, size_t len, uint8_t *pdata);
HAL_StatusTypeDef __lsm303_mread(uint8_t reg, size_t len, uint8_t *pdata);

HAL_StatusTypeDef _lsm303_mode_normal();
HAL_StatusTypeDef _lsm303_mode_lowpower();
HAL_StatusTypeDef _lsm303_power_down();
HAL_StatusTypeDef _lsm303_datarate_set(enum LSM303_DATARATE rate);
HAL_StatusTypeDef _lsm303_xyz_set(uint8_t setting);
HAL_StatusTypeDef _lsm303_highpass_mode_set(enum LSM303_HIGHPASS_MODE mode);
HAL_StatusTypeDef _lsm303_highpass_filter_data_selection(enum LSM303_FILTER_DATA_SELECTION);
HAL_StatusTypeDef _lsm303_highpass_filter_enable(uint8_t enable);
HAL_StatusTypeDef _lsm303_interrupt(uint8_t interrupt_en);
HAL_StatusTypeDef _lsm303_block_data_set(enum LSM303_BLOCK_DATA);
HAL_StatusTypeDef _lsm303_endianess(enum LSM303_ENDIANNESS);
HAL_StatusTypeDef _lsm303_scale(enum LSM303_SCALE);
HAL_StatusTypeDef _lsm303_high_resolution(enum LSM303_HIGH_RESOLUTION);
HAL_StatusTypeDef _lsm303_spi_mode(enum LSM303_SPI_MODE);
HAL_StatusTypeDef _lsm303_boot_content(enum LSM303_BOOT);
HAL_StatusTypeDef _lsm303_fifo(enum LSM303_FIFO_EN);
HAL_StatusTypeDef _lsm303_latch_interrupt1(enum LSM303_LATCH_INTERRUPT_REQUEST);
HAL_StatusTypeDef _lsm303_latch_interrupt2(enum LSM303_LATCH_INTERRUPT_REQUEST);
HAL_StatusTypeDef _lsm303_4d_detection_interrupt1(enum LSM303_4D_DETECTION);
HAL_StatusTypeDef _lsm303_4d_detection_interrupt2(enum LSM303_4D_DETECTION);
HAL_StatusTypeDef _lsm303_click_interrupt_pad2(enum LSM303_INTERRUPT_EN en);
HAL_StatusTypeDef _lsm303_interrupt1_pad2(enum LSM303_INTERRUPT_EN en);
HAL_StatusTypeDef _lsm303_interrupt2_pad2(enum LSM303_INTERRUPT_EN en);
HAL_StatusTypeDef _lsm303_boot_pad2(bool en);
HAL_StatusTypeDef _lsm303_p2_active_function_status(bool en);
HAL_StatusTypeDef _lsm303_interrupt_active(enum LSM303_INTERRUPT_ACTIVE active);
HAL_StatusTypeDef _lsm303_reference_write(uint8_t ref);
HAL_StatusTypeDef _lsm303_reference_read(uint8_t *pref);
HAL_StatusTypeDef _lsm303_status_read(uint8_t *pstatus);
HAL_StatusTypeDef _lsm303_accel_data(uint8_t *pdata);
#endif